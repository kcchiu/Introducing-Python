...
#    for sig in [0.1, 0.2, 0.5, 0.7, 1.0, 1.5, 2.0]:
#        for low_c in frange(0,0.5,0.1):
#            for high_c in frange(0.5,1.0,0.1):
#                print "sigma:", sig, "low_c:", low_c, "high_c:", high_c
#                E = cannyEdge(I, sig, low_c, high_c, filename)
    #E = cannyEdge(I, 0.2, 0.1, 0.9, filename)
    #E = cannyEdge(I, 1, 0.1, 0.9, filename)
    E = cannyEdge(I, 0.5, 0.1, 0.9, filename)
